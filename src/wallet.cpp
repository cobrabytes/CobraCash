...
// CobraCash: total coins staked (non-spendable until maturity)
...
// CobraCash: get current stake weight
...
// CobraCash: check 'spent' consistency between wallet and txindex
// CobraCash: fix wallet spent state according to txindex
...
// CobraCash: disable transaction (only for coinstake)
